...
function insertSession(_a) {
    var user_id = _a.user_id, token = _a.token;
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, connection.query("INSERT INTO sessions (user_id, token) VALUES ($1,$2);", [user_id, token])];
